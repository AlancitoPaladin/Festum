...
class ProviderServiceImage {
  const ProviderServiceImage({
    required this.key,
    required this.asset,
  ...
  bool get hasVisibleUrl => resolvedImageUrl.isNotEmpty;

  ProviderServiceImage copyWith({
    String? key,
  ...
  factory ProviderServiceImage.fromJson(
